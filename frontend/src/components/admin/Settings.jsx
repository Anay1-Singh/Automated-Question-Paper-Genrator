    ...
    <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-5">
          ...
          <div className="flex-1 space-y-3 w-full">
            <div className="flex flex-wrap items-center gap-2">
              <h4 className="text-sm font-bold text-white">{user.name || 'Admin User'}</h4>
            ...
            <button className="inline-flex items-center gap-2 rounded-xl border border-indigo-500/20 bg-indigo-500/10 px-4 py-2 text-xs font-bold text-indigo-300 transition-colors hover:bg-indigo-500/20">
      ...
      <div className="rounded-2xl border border-[#1a1a2e] bg-[#0f0f14] p-5">
        ...
        <div className="space-y-3 max-w-md">
          <div>
            ...
            <input
              type="password"
              className="w-full rounded-xl border border-[#27272A] bg-[#09090B] px-3 py-2.5 text-sm text-white outline-none placeholder:text-zinc-700 focus:border-indigo-500"
              placeholder="••••••••"
            />
          </div>
          <div>
          ...
          <button className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-xs font-bold text-white shadow-lg shadow-indigo-900/20 transition-all hover:-translate-y-0.5 hover:bg-indigo-500">
      ...
      <div className="rounded-2xl border border-[#1a1a2e] bg-[#0f0f14] p-5">
        ...
        <div className="space-y-4">
          {[
            { label: 'Email notifications for paper generation', defaultChecked: true },
            { label: 'Email notifications for new uploads', defaultChecked: true },
            ...
            <label key={item.label} className="flex items-center justify-between gap-4 cursor-pointer group">
              ...
              <div className="relative">
                ...
                <div className="h-6 w-11 rounded-full bg-[#27272A] transition-colors peer-checked:bg-indigo-600" />
      ...
      <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-5">
        ...
        <p className="text-xs text-zinc-500 mb-4">
          Once you delete your account, there is no going back. All your uploaded documents, generated papers, and question bank data will be permanently removed.
        </p>
